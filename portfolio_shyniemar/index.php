...
// Query to fetch introduction data
 ...
 <div class="shygal">
     ...
     <div class="gallery-shy" data-aos="zoom-in-up">
         ...
         foreach ($galleryImages as $image) {
             // proper path makes eveythinig easy
...
<section id="contact">
  ...
  <div class="green" data-aos="fade-in">
    <img  class ="imgcontact"src="assets2/img/cute.png" alt="">
  </div>
</section>
...
function positionExperienceCard() {
    ...
    // If you want to use the centered horizontal position, you can uncomment the line below
    // experienceCard.style.left = leftPosition + 'px';
}
