                                ...
                                if ($stmt !== false) {
                                    if ($stmt->rowCount() > 0) {
                                        while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                                            ...
                                            echo "<td>
                                                    <a href='edit_inquiries.php?id=" . $row['id'] . "' class='btn btn-sm btn-info'>Edit</a>
                                                    <a href='delete_inquiries.php?id=" . $row['id'] . "' class='btn btn-sm btn-danger'>Delete</a>
                                                  </td>";
                                            echo "</tr>";
                                        }
                                    } else {
                                    ...
                                    // Error handling if $stmt is null
